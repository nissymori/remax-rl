...
class REPPOConfig(BaseModel):
    ...
    wandb_project: str = "pgx-minatar-reppo"
...
def calc_remax_advantage(R: jnp.ndarray, q: jnp.ndarray, pi: jnp.ndarray, action: jnp.ndarray, M: float, use_baseline: bool = True, replace_q: bool = False, replace_type: Literal["return", "q_r_m"] = "return"):
    """R:(B,) or (B,1) -> (B,)"""
